...
export function SignUp() {
  ...
  return (
    <FormProvider {...methods}>
      <div className="grid h-screen grid-cols-1 items-center py-2">
        <form
          className="mx-auto flex w-full max-w-[500px] flex-col gap-4 rounded-2xl p-4 shadow-[0_4px_20px_rgba(0,0,0,0.08)]"
        ...
        >
          ...
          />
          <button
            className="mt-2 rounded-lg bg-purple-800 px-3 py-2 text-white"
            type="submit"
          >
            Зарегистрироваться
          </button>
